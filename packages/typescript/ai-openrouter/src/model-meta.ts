...
const GOOGLE_GEMMA_3_27B_IT_FREE =  {
    ...
    supports: {
      input: ['text', 'image'],
      output: ['text'],
      supports: ['frequency_penalty', 'max_tokens', 'presence_penalty', 'repetition_penalty', 'response_format', 'seed', 'stop', 'temperature', 'tool_choice', 'tools', 'top_p'],
    },
    context_window: 131072,
    pricing: {
      text: {
...
const XIAOMI_MIMO_V2_FLASH_FREE =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'max_tokens', 'presence_penalty', 'reasoning', 'response_format', 'stop', 'temperature', 'tool_choice', 'tools', 'top_p'],
    },
    context_window: 262144,
    max_output_tokens: 65536,
    pricing: {
...
const DEEPSEEK_DEEPSEEK_R1_0528_FREE =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'max_tokens', 'presence_penalty', 'reasoning', 'repetition_penalty', 'temperature'],
    },
    context_window: 163840,
    pricing: {
      text: {
...
const META_LLAMA_LLAMA_3_1_405B_INSTRUCT_FREE =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'max_tokens', 'presence_penalty', 'repetition_penalty', 'temperature'],
    },
    context_window: 131072,
    pricing: {
      text: {
...
const QWEN_QWEN3_8B =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'logit_bias', 'logprobs', 'max_tokens', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_logprobs', 'top_p'],
    },
    context_window: 131072,
...
const ARCEE_AI_TRINITY_MINI =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'logit_bias', 'max_tokens', 'min_p', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_p'],
    },
    context_window: 131072,
    max_output_tokens: 131072,
    pricing: {
...
const QWEN_QWEN2_5_VL_32B_INSTRUCT =  {
    ...
    supports: {
      input: ['text', 'image'],
      output: ['text'],
      supports: ['frequency_penalty', 'logit_bias', 'logprobs', 'max_tokens', 'min_p', 'presence_penalty', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'top_k', 'top_logprobs', 'top_p'],
    },
    context_window: 32768,
    max_output_tokens: 16384,
    pricing: {
...
const BYTEDANCE_SEED_SEED_1_6_FLASH =  {
    ...
    supports: {
      input: ['image', 'text', 'video'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'max_tokens', 'reasoning', 'response_format', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_p'],
    },
    context_window: 262144,
    max_output_tokens: 16384,
    pricing: {
...
const DEEPCOGITO_COGITO_V2_PREVIEW_LLAMA_109B_MOE =  {
    ...
    supports: {
      input: ['image', 'text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'logit_bias', 'max_tokens', 'min_p', 'presence_penalty', 'reasoning', 'repetition_penalty', 'stop', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_p'],
    },
    context_window: 131072,
    pricing: {
      text: {
...
const QWEN_QWEN3_CODER_EXACTO =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'max_tokens', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_p'],
    },
    context_window: 1048576,
    max_output_tokens: 65536,
    pricing: {
...
const DEEPSEEK_DEEPSEEK_R1_DISTILL_QWEN_32B =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'max_tokens', 'min_p', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'top_k', 'top_p'],
    },
    context_window: 128000,
    pricing: {
      text: {
...
const Z_AI_GLM_4_6 =  {
    ...
    supports: {
      input: ['text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'logit_bias', 'logprobs', 'max_tokens', 'min_p', 'presence_penalty', 'reasoning', 'repetition_penalty', 'response_format', 'seed', 'stop', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_a', 'top_k', 'top_logprobs', 'top_p'],
    },
    context_window: 200000,
    max_output_tokens: 65536,
    pricing: {
...
const STEPFUN_AI_STEP3 =  {
    ...
    supports: {
      input: ['image', 'text'],
      output: ['text'],
      supports: ['frequency_penalty', 'include_reasoning', 'reasoning', 'response_format', 'structured_outputs', 'temperature', 'tool_choice', 'tools', 'top_k', 'top_p'],
    },
    context_window: 65536,
    max_output_tokens: 65536,
    pricing: {
...
export type OpenRouterModelOptionsByName  = {
  ...
  [META_LLAMA_LLAMA_3_3_70B_INSTRUCT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [QWEN_QWEN3_CODER_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [TNGTECH_DEEPSEEK_R1T2_CHIMERA_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [MOONSHOTAI_KIMI_K2_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'seed' | 'stop' | 'temperature'>;
  [GOOGLE_GEMMA_3_27B_IT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [TNGTECH_TNG_R1T_CHIMERA_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [TNGTECH_DEEPSEEK_R1T_CHIMERA_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [GOOGLE_GEMINI_2_0_FLASH_EXP_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [MISTRALAI_DEVSTRAL_2512_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [XIAOMI_MIMO_V2_FLASH_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [ALLENAI_MOLMO_2_8B_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [DEEPSEEK_DEEPSEEK_R1_0528_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'temperature'>;
  ...
  [META_LLAMA_LLAMA_3_1_405B_INSTRUCT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'temperature'>;
  [QWEN_QWEN_2_5_VL_7B_INSTRUCT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'temperature'>;
  [MISTRALAI_MISTRAL_7B_INSTRUCT_FREE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [META_LLAMA_LLAMA_3_2_3B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [META_LLAMA_LLAMA_GUARD_3_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [NOUSRESEARCH_DEEPHERMES_3_MISTRAL_24B_PREVIEW.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MISTRALAI_MISTRAL_7B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MISTRALAI_MISTRAL_SMALL_3_1_24B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [DEEPSEEK_DEEPSEEK_R1_DISTILL_LLAMA_70B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [QWEN_QWEN_2_5_CODER_32B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [MISTRALAI_MINISTRAL_3B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [ARCEE_AI_TRINITY_MINI.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MICROSOFT_PHI_4_MULTIMODAL_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN2_5_VL_32B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [MISTRALAI_DEVSTRAL_2512.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_R1_0528_QWEN3_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [MISTRALAI_DEVSTRAL_SMALL_2505.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [MISTRALAI_DEVSTRAL_SMALL.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MICROSOFT_PHI_4_REASONING_PLUS.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [BYTEDANCE_SEED_SEED_1_6_FLASH.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [QWEN_QWEN3_32B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [META_LLAMA_LLAMA_4_SCOUT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [QWEN_QWEN3_30B_A3B_INSTRUCT_2507.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [ALIBABA_TONGYI_DEEPRESEARCH_30B_A3B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MISTRALAI_PIXTRAL_12B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [MISTRAL_MINISTRAL_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [MISTRALAI_MINISTRAL_8B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  [ALLENAI_OLMO_3_7B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [BYTEDANCE_UI_TARS_1_5_7B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_VL_4B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [NOUSRESEARCH_HERMES_4_70B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [ALLENAI_OLMO_3_7B_THINK.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [QWEN_QWEN_2_5_72B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_R1_DISTILL_QWEN_14B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [ALLENAI_OLMO_3_1_32B_THINK.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [ALLENAI_OLMO_3_32B_THINK.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [QWEN_QWEN3_VL_30B_A3B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [QWEN_QWEN2_5_VL_72B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_235B_A22B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [DEEPCOGITO_COGITO_V2_PREVIEW_LLAMA_109B_MOE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [AI21_JAMBA_MINI_1_7.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [MINIMAX_MINIMAX_M2.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [MINIMAX_MINIMAX_01.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'temperature' | 'top_p'>;
  [PRIME_INTELLECT_INTELLECT_3.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [QWEN_QWEN3_VL_235B_A22B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_V3_2_EXP.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_CODER.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [QWEN_QWEN3_CODER_EXACTO.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [MISTRALAI_MISTRAL_TINY.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [TNGTECH_TNG_R1T_CHIMERA.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [BYTEDANCE_SEED_SEED_1_6.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'temperature' | 'tool_choice' | 'top_p'>;
  [DEEPSEEK_DEEPSEEK_R1_DISTILL_QWEN_32B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [DEEPSEEK_DEEPSEEK_V3_2_SPECIALE.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [MOONSHOTAI_KIMI_DEV_72B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'reasoning' | 'response_format' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [META_LLAMA_LLAMA_3_70B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [THEDRUMMER_CYDONIA_24B_V4_1.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [Z_AI_GLM_4_6V.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [TNGTECH_DEEPSEEK_R1T_CHIMERA.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [GOOGLE_GEMINI_2_5_FLASH_IMAGE_PREVIEW.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'max_completion_tokens' | 'response_format' | 'seed' | 'temperature' | 'top_p'>;
  [GOOGLE_GEMINI_2_5_FLASH_PREVIEW_09_2025.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_p'>;
  ...
  [Z_AI_GLM_4_6.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_a' | 'top_k' | 'top_logprobs' | 'top_p'>;
  [Z_AI_GLM_4_5.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [Z_AI_GLM_4_7.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_a' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [MOONSHOTAI_KIMI_K2_THINKING.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [MICROSOFT_WIZARDLM_2_8X22B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [QWEN_QWEN3_VL_32B_INSTRUCT.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_PROVER_V2.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  ...
  [THEDRUMMER_SKYFALL_36B_V2.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'top_k' | 'top_p'>;
  [MINIMAX_MINIMAX_M1_80K.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  [STEPFUN_AI_STEP3.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'reasoning' | 'response_format' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [DEEPSEEK_DEEPSEEK_R1.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [DEEPCOGITO_COGITO_V2_PREVIEW_LLAMA_70B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [NEVERSLEEP_NOROMAID_20B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'repetition_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_a' | 'top_k' | 'top_logprobs' | 'top_p'>;
  ...
  [ANTHROPIC_CLAUDE_HAIKU_4_5.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [OPENAI_CODEX_MINI.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'include_reasoning' | 'max_completion_tokens' | 'reasoning' | 'response_format' | 'seed' | 'tool_choice'>;
  ...
  [DEEPCOGITO_COGITO_V2_PREVIEW_LLAMA_405B.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'include_reasoning' | 'logit_bias' | 'max_completion_tokens' | 'min_p' | 'presence_penalty' | 'reasoning' | 'repetition_penalty' | 'response_format' | 'stop' | 'temperature' | 'tool_choice' | 'top_k' | 'top_p'>;
  ...
  [OPENAI_CHATGPT_4O_LATEST.id]: OpenRouterCommonOptions & Pick<OpenRouterBaseOptions,'frequency_penalty' | 'logit_bias' | 'logprobs' | 'max_completion_tokens' | 'presence_penalty' | 'response_format' | 'seed' | 'stop' | 'temperature' | 'top_logprobs' | 'top_p'>;
...
export type OpenRouterModelInputModalitiesByName  = {
  ...
  [DEEPCOGITO_COGITO_V2_PREVIEW_LLAMA_109B_MOE.id]: ReadonlyArray<'image' | 'text'>;
  ...
  [GOOGLE_GEMINI_2_5_FLASH_PREVIEW_09_2025.id]: ReadonlyArray<'image' | 'document' | 'text' | 'audio' | 'video'>;
