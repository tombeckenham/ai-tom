...
export type OpenRouterModelOptionsByName = {
  ...
  [OPENROUTER_FREE.id]: OpenRouterCommonOptions &
    Pick<
      ...
      | 'top_p'
    >
  [STEPFUN_STEP_3_5_FLASH_FREE.id]: OpenRouterCommonOptions &
    Pick<
      OpenRouterBaseOptions,
      | 'frequency_penalty'
      | 'include_reasoning'
  ...
  [MOONSHOTAI_KIMI_K2_5.id]: OpenRouterCommonOptions &
    Pick<
      ...
      | 'top_p'
    >
  [UPSTAGE_SOLAR_PRO_3_FREE.id]: OpenRouterCommonOptions &
    Pick<
      OpenRouterBaseOptions,
      | 'include_reasoning'
      | 'max_completion_tokens'
  ...
  [OPENAI_GPT_5_2_CODEX.id]: OpenRouterCommonOptions &
    Pick<
      ...
      | 'tool_choice'
    >
  [ALLENAI_MOLMO_2_8B.id]: OpenRouterCommonOptions &
    Pick<
      OpenRouterBaseOptions,
      | 'frequency_penalty'
      | 'logit_bias'
