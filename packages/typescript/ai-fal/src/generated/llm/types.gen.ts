 ...
 * OutputModel
 */
export type SchemaVideoPromptGeneratorOutput = {
  /**
   * Prompt
   *
 ...
 * InputModel
 */
export type SchemaVideoPromptGeneratorInput = {
  /**
   * Custom Elements
   *
 ...
 * Qwen3GuardOutput
 */
export type SchemaQwen3GuardOutput = {
  /**
   * Categories
   *
 ...
 */
export type SchemaRouterOpenaiV1ChatCompletionsInput = {
  [key: string]: unknown
}

export type SchemaRouterOpenaiV1ChatCompletionsOutput = unknown
 ...
 * ChatOutput
 */
export type SchemaRouterOutput = {
  /**
   * Usage
   *
 ...
 * Schema referenced but not defined by fal.ai (missing from source OpenAPI spec)
 */
export type SchemaRouterOpenaiV1EmbeddingsInput = {
  [key: string]: unknown
}

export type SchemaRouterOpenaiV1EmbeddingsOutput = unknown

/**
 * Schema referenced but not defined by fal.ai (missing from source OpenAPI spec)
 */
export type SchemaRouterOpenaiV1ResponsesInput = {
  [key: string]: unknown
}

export type SchemaRouterOpenaiV1ResponsesOutput = unknown
...
export type PostOpenrouterRouterOpenaiV1ResponsesData = {
  body: SchemaRouterOpenaiV1ResponsesInput
  path?: never
  query?: never
...
export type GetOpenrouterRouterOpenaiV1ResponsesRequestsByRequestIdResponses = {
   ...
   */
  200: SchemaRouterOpenaiV1ResponsesOutput
}
...
export type PostOpenrouterRouterOpenaiV1EmbeddingsData = {
  body: SchemaRouterOpenaiV1EmbeddingsInput
  path?: never
  query?: never
...
export type GetOpenrouterRouterOpenaiV1EmbeddingsRequestsByRequestIdResponses =
  {
     ...
     * Result of the request.
     */
    200: SchemaRouterOpenaiV1EmbeddingsOutput
  }
...
export type PostOpenrouterRouterOpenaiV1ChatCompletionsData = {
  body: SchemaRouterOpenaiV1ChatCompletionsInput
  path?: never
  query?: never
...
export type GetOpenrouterRouterOpenaiV1ChatCompletionsRequestsByRequestIdResponses =
  {
     ...
     * Result of the request.
     */
    200: SchemaRouterOpenaiV1ChatCompletionsOutput
  }
...
export type PostFalAiVideoPromptGeneratorData = {
  body: SchemaVideoPromptGeneratorInput
  path?: never
  query?: never
