...
export type Ltx219bImageToVideoInput = {
     ...
     * The size of the generated video.
     */
    video_size?: FalAiLtx219bImageToVideoImageSize | 'auto' | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Guidance Scale
     *
...
export type PixverseV45ImageToVideoFastInput = {
     ...
     */
    camera_movement?: 'horizontal_left' | 'horizontal_right' | 'vertical_up' | 'vertical_down' | 'zoom_in' | 'zoom_out' | 'crane_up' | 'quickly_zoom_in' | 'quickly_zoom_out' | 'smooth_zoom_in' | 'camera_rotation' | 'robo_arm' | 'super_dolly_out' | 'whip_pan' | 'hitchcock' | 'left_follow' | 'right_follow' | 'pan_left' | 'pan_right' | 'fix_bg';
    /**
     * Image Url
     *
     * URL of the image to use as the first frame
...
export type Cogvideox5bImageToVideoInput = {
     ...
     * The size of the generated video.
     */
    video_size?: FalAiCogvideox5bImageToVideoImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Guidance scale (CFG)
     *
     *
