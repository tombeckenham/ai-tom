 ...
 * Output
 */
export type SchemaHunyuanVideoLoraTrainingOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * PublicInput
 */
export type SchemaHunyuanVideoLoraTrainingInput = {
  /**
   * Trigger Word
   *
 ...
 * Output
 */
export type SchemaWanTrainerOutput = {
  /**
   * Lora File
   *
   * URL to the trained LoRA weights.
   */
  lora_file: SchemaFile
  /**
   * Config File
   *
 ...
 * Input
 */
export type SchemaWanTrainerInput = {
  /**
   * Number Of Steps
   *
 ...
 * Output
 */
export type SchemaTurboFluxTrainerOutput = {
  /**
   * Config File
   *
 ...
 * Input
 */
export type SchemaTurboFluxTrainerInput = {
  /**
   * Images Data Url
   *
   *
 ...
 */
export type SchemaRecraftV3CreateStyleOutput = {
  /**
   * Style Id
   *
 ...
 * StyleReferenceInput
 */
export type SchemaRecraftV3CreateStyleInput = {
  /**
   * Images Data Url
   *
 ...
 * TrainingOutput
 */
export type SchemaLtxVideoTrainerOutput = {
  lora_file: SchemaFile
  config_file: SchemaFile
  /**
 ...
 * Input
 */
export type SchemaLtxVideoTrainerInput = {
  /**
   * Number Of Steps
   *
   * The number of steps to train for.
   ...
   */
  validation?: Array<SchemaValidation>
  /**
   * Number Of Frames
   *
 ...
 * Output
 */
export type SchemaWanTrainerFlf2V720pOutput = {
  /**
   * Lora File
   *
   * URL to the trained LoRA weights.
 ...
 * Input
 */
export type SchemaWanTrainerFlf2V720pInput = {
  /**
   * Number Of Steps
   *
   * The number of steps to train for.
 ...
 * Output
 */
export type SchemaWanTrainerI2V720pOutput = {
  /**
   * Lora File
   *
   * URL to the trained LoRA weights.
 ...
 * Input
 */
export type SchemaWanTrainerI2V720pInput = {
  /**
   * Number Of Steps
   *
   * The number of steps to train for.
 ...
 * Output
 */
export type SchemaWanTrainerT2V14bOutput = {
  /**
   * Lora File
   *
   * URL to the trained LoRA weights.
 ...
 * Input
 */
export type SchemaWanTrainerT2V14bInput = {
  /**
   * Number Of Steps
   *
   * The number of steps to train for.
 ...
 * Output
 */
export type SchemaWanTrainerT2vOutput = {
  /**
   * Lora File
   *
   * URL to the trained LoRA weights.
 ...
 * Input
 */
export type SchemaWanTrainerT2vInput = {
  /**
   * Number Of Steps
   *
   * The number of steps to train for.
 ...
 * WanTrainerResponse
 */
export type SchemaWan22ImageTrainerOutput = {
  /**
   * Config File
   *
 ...
 * BasicInput
 */
export type SchemaWan22ImageTrainerInput = {
  /**
   * Trigger Phrase
   *
 ...
 * Output
 */
export type SchemaQwenImageTrainerOutput = {
  /**
   * Lora File
   *
 ...
 * PublicInput
 */
export type SchemaQwenImageTrainerInput = {
  /**
   * Steps
   *
 ...
 * Output
 */
export type SchemaQwenImageEditTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputEdit
 */
export type SchemaQwenImageEditTrainerInput = {
  /**
   * Steps
   *
 ...
 * Output
 */
export type SchemaQwenImageEditPlusTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputPlus
 */
export type SchemaQwenImageEditPlusTrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaFlux2TrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputT2I
 */
export type SchemaFlux2TrainerInput = {
  /**
   * Steps
   *
 ...
 * Output
 */
export type SchemaFlux2TrainerEditOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputEdit
 */
export type SchemaFlux2TrainerEditInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaZImageTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input
 */
export type SchemaZImageTrainerInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaQwenImageEdit2509TrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputPlus
 */
export type SchemaQwenImageEdit2509TrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaQwenImageLayeredTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input
 */
export type SchemaQwenImageLayeredTrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaQwenImageEdit2511TrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input2511
 */
export type SchemaQwenImageEdit2511TrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaQwenImage2512TrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputImage
 */
export type SchemaQwenImage2512TrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 */
export type SchemaLtx2VideoTrainerOutput = {
  lora_file: SchemaFile
  config_file: SchemaFile
  /**
   * URL to the debug dataset archive containing decoded videos and audio.
   */
  debug_dataset?: SchemaFile | unknown
  /**
 ...
 */
export type SchemaLtx2VideoTrainerInput = {
  /**
   * Number Of Steps
   *
 ...
 */
export type SchemaV2vValidation = {
  /**
   * Prompt
   *
   * The prompt to use for validation.
 ...
 */
export type SchemaLtx2V2vTrainerOutput = {
  lora_file: SchemaFile
  config_file: SchemaFile
  /**
...
export type SchemaLtx2V2vTrainerInput = {
   ...
   */
  validation?: Array<SchemaV2vValidation>
  /**
   * Number Of Frames
   *
   * Number of frames per training sample. Must satisfy frames % 8 == 1 (e.g., 1, 9, 17, 25, 33, 41, 49, 57, 65, 73, 81, 89, 97).
 ...
 * Output
 */
export type SchemaFlux2TrainerV2Output = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 */
export type SchemaFlux2TrainerV2Input = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaFlux2TrainerV2EditOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputEditV2
 */
export type SchemaFlux2TrainerV2EditInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaQwenImage2512TrainerV2Output = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input
 */
export type SchemaQwenImage2512TrainerV2Input = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaFlux2Klein4bBaseTrainerEditOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputEditV2
 */
export type SchemaFlux2Klein4bBaseTrainerEditInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaFlux2Klein4bBaseTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * V2 input with multi-resolution bucketing.
 */
export type SchemaFlux2Klein4bBaseTrainerInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaFlux2Klein9bBaseTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * V2 input with multi-resolution bucketing.
 */
export type SchemaFlux2Klein9bBaseTrainerInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaFlux2Klein9bBaseTrainerEditOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * InputEditV2
 */
export type SchemaFlux2Klein9bBaseTrainerEditInput = {
  /**
   * Steps
   *
   * Total number of training steps.
 ...
 * Output
 */
export type SchemaZImageTurboTrainerV2Output = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input
 */
export type SchemaZImageTurboTrainerV2Input = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaZImageBaseTrainerOutput = {
  config_file: SchemaFile
  diffusers_lora_file: SchemaFile
}
 ...
 * Input
 */
export type SchemaZImageBaseTrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaFluxLoraPortraitTrainerOutput = {
  /**
   * Config File
   *
   * URL to the training configuration file.
 ...
 * PublicInput
 */
export type SchemaFluxLoraPortraitTrainerInput = {
  /**
   * Images Data Url
   *
   *
 ...
 * Output
 */
export type SchemaFluxLoraFastTrainingOutput = {
  /**
   * Config File
   *
   * URL to the training configuration file.
   ...
   */
  debug_preprocessed_output?: SchemaFile
  /**
   * Diffusers Lora File
   *
   * URL to the trained diffusers lora weights.
 ...
 * PublicInput
 */
export type SchemaFluxLoraFastTrainingInput = {
  /**
   * Images Data Url
   *
   *
 ...
 * Output
 */
export type SchemaFluxKontextTrainerOutput = {
  /**
   * Config File
   *
 ...
 * Input
 */
export type SchemaFluxKontextTrainerInput = {
  /**
   * Steps
   *
   * Number of steps to train for
 ...
 * Output
 */
export type SchemaFluxKreaTrainerOutput = {
  /**
   * Config File
   *
   * URL to the training configuration file.
 ...
 * PublicInput
 */
export type SchemaFluxKreaTrainerInput = {
  /**
   * Images Data Url
   *
   *
...
export type PostFalAiFluxKreaTrainerData = {
  body: SchemaFluxKreaTrainerInput
  path?: never
  query?: never
...
export type GetFalAiFluxKreaTrainerRequestsByRequestIdResponses = {
   ...
   */
  200: SchemaFluxKreaTrainerOutput
}
...
export type PostFalAiFluxKontextTrainerData = {
  body: SchemaFluxKontextTrainerInput
  path?: never
  query?: never
...
export type PostFalAiFluxLoraFastTrainingData = {
  body: SchemaFluxLoraFastTrainingInput
  path?: never
  query?: never
...
export type PostFalAiFluxLoraPortraitTrainerData = {
  body: SchemaFluxLoraPortraitTrainerInput
  path?: never
  query?: never
...
export type GetFalAiFluxLoraPortraitTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFluxLoraPortraitTrainerOutput
}
...
export type PostFalAiZImageBaseTrainerData = {
  body: SchemaZImageBaseTrainerInput
  path?: never
  query?: never
...
export type GetFalAiZImageTurboTrainerV2RequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaZImageTurboTrainerV2Output
}
...
export type PostFalAiFlux2Klein9bBaseTrainerEditData = {
  body: SchemaFlux2Klein9bBaseTrainerEditInput
  path?: never
  query?: never
...
export type GetFalAiFlux2Klein9bBaseTrainerEditRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFlux2Klein9bBaseTrainerEditOutput
}
...
export type PostFalAiFlux2Klein9bBaseTrainerData = {
  body: SchemaFlux2Klein9bBaseTrainerInput
  path?: never
  query?: never
...
export type GetFalAiFlux2Klein9bBaseTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFlux2Klein9bBaseTrainerOutput
}
...
export type PostFalAiFlux2Klein4bBaseTrainerData = {
  body: SchemaFlux2Klein4bBaseTrainerInput
  path?: never
  query?: never
...
export type GetFalAiFlux2Klein4bBaseTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFlux2Klein4bBaseTrainerOutput
}
...
export type PostFalAiFlux2Klein4bBaseTrainerEditData = {
  body: SchemaFlux2Klein4bBaseTrainerEditInput
  path?: never
  query?: never
...
export type GetFalAiFlux2Klein4bBaseTrainerEditRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFlux2Klein4bBaseTrainerEditOutput
}
...
export type PostFalAiQwenImage2512TrainerV2Data = {
  body: SchemaQwenImage2512TrainerV2Input
  path?: never
  query?: never
...
export type PostFalAiFlux2TrainerV2EditData = {
  body: SchemaFlux2TrainerV2EditInput
  path?: never
  query?: never
...
export type GetFalAiFlux2TrainerV2RequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaFlux2TrainerV2Output
}
...
export type PostFalAiLtx2V2vTrainerData = {
  body: SchemaLtx2V2vTrainerInput
  path?: never
  query?: never
...
export type GetFalAiLtx2V2vTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaLtx2V2vTrainerOutput
}
...
export type PostFalAiLtx2VideoTrainerData = {
  body: SchemaLtx2VideoTrainerInput
  path?: never
  query?: never
...
export type PostFalAiQwenImage2512TrainerData = {
  body: SchemaQwenImage2512TrainerInput
  path?: never
  query?: never
...
export type GetFalAiQwenImage2512TrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwenImage2512TrainerOutput
}
...
export type GetFalAiQwenImageEdit2511TrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwenImageEdit2511TrainerOutput
}
...
export type PostFalAiQwenImageLayeredTrainerData = {
  body: SchemaQwenImageLayeredTrainerInput
  path?: never
  query?: never
...
export type PostFalAiQwenImageEdit2509TrainerData = {
  body: SchemaQwenImageEdit2509TrainerInput
  path?: never
  query?: never
...
export type PostFalAiFlux2TrainerEditData = {
  body: SchemaFlux2TrainerEditInput
  path?: never
  query?: never
...
export type PostFalAiQwenImageEditPlusTrainerData = {
  body: SchemaQwenImageEditPlusTrainerInput
  path?: never
  query?: never
...
export type GetFalAiQwenImageEditPlusTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwenImageEditPlusTrainerOutput
}
...
export type PostFalAiQwenImageEditTrainerData = {
  body: SchemaQwenImageEditTrainerInput
  path?: never
  query?: never
...
export type GetFalAiQwenImageEditTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwenImageEditTrainerOutput
}
...
export type PostFalAiQwenImageTrainerData = {
  body: SchemaQwenImageTrainerInput
  path?: never
  query?: never
...
export type GetFalAiQwenImageTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwenImageTrainerOutput
}
...
export type PostFalAiWan22ImageTrainerData = {
  body: SchemaWan22ImageTrainerInput
  path?: never
  query?: never
...
export type PostFalAiWanTrainerT2V14bData = {
  body: SchemaWanTrainerT2V14bInput
  path?: never
  query?: never
...
export type GetFalAiWanTrainerT2V14bRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaWanTrainerT2V14bOutput
}
...
export type PostFalAiWanTrainerI2V720pData = {
  body: SchemaWanTrainerI2V720pInput
  path?: never
  query?: never
...
export type GetFalAiWanTrainerI2V720pRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaWanTrainerI2V720pOutput
}
...
export type PostFalAiWanTrainerFlf2V720pData = {
  body: SchemaWanTrainerFlf2V720pInput
  path?: never
  query?: never
...
export type GetFalAiWanTrainerFlf2V720pRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaWanTrainerFlf2V720pOutput
}
...
export type PostFalAiLtxVideoTrainerData = {
  body: SchemaLtxVideoTrainerInput
  path?: never
  query?: never
...
export type PostFalAiRecraftV3CreateStyleData = {
  body: SchemaRecraftV3CreateStyleInput
  path?: never
  query?: never
...
export type GetFalAiRecraftV3CreateStyleRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaRecraftV3CreateStyleOutput
}
...
export type PostFalAiTurboFluxTrainerData = {
  body: SchemaTurboFluxTrainerInput
  path?: never
  query?: never
...
export type GetFalAiTurboFluxTrainerRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaTurboFluxTrainerOutput
}
...
export type PostFalAiHunyuanVideoLoraTrainingData = {
  body: SchemaHunyuanVideoLoraTrainingInput
  path?: never
  query?: never
...
export type GetFalAiHunyuanVideoLoraTrainingRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaHunyuanVideoLoraTrainingOutput
}
