 ...
 * AudioOutput
 */
export type SchemaRouterAudioOutput = {
  /**
   * Usage
   *
 ...
 * AudioInput
 */
export type SchemaRouterAudioInput = {
  /**
   * Prompt
   *
 ...
 */
export type SchemaQwen3TtsCloneVoice06bOutput = {
  /**
   * Speaker Embedding
   *
   * The generated speaker embedding file in safetensors format.
   */
  speaker_embedding: SchemaFile
}
 ...
 */
export type SchemaQwen3TtsCloneVoice06bInput = {
  /**
   * Audio Url
   *
 ...
 * Qwen3CloneVoiceInput
 */
export type SchemaQwen3TtsCloneVoice17bInput = {
  /**
   * Audio Url
   *
   * URL to the reference audio file used for voice cloning.
 ...
 */
export type SchemaWorkflowUtilitiesInterleaveVideoOutput = {
  /**
   * Video
   *
 ...
 */
export type SchemaWorkflowUtilitiesInterleaveVideoInput = {
  /**
   * Video Urls
   *
...
export type PostFalAiWorkflowUtilitiesInterleaveVideoData = {
  body: SchemaWorkflowUtilitiesInterleaveVideoInput
  path?: never
  query?: never
...
export type GetFalAiWorkflowUtilitiesInterleaveVideoRequestsByRequestIdResponses =
  {
     ...
     */
    200: SchemaWorkflowUtilitiesInterleaveVideoOutput
  }
...
export type PostFalAiQwen3TtsCloneVoice17bData = {
  body: SchemaQwen3TtsCloneVoice17bInput
  path?: never
  query?: never
...
export type PostFalAiQwen3TtsCloneVoice06bData = {
  body: SchemaQwen3TtsCloneVoice06bInput
  path?: never
  query?: never
...
export type GetFalAiQwen3TtsCloneVoice06bRequestsByRequestIdResponses = {
   ...
   * Result of the request.
   */
  200: SchemaQwen3TtsCloneVoice06bOutput
}
