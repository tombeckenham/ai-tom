...
export type Flux2ProEditInput = {
     ...
     */
    image_size?: FalAiFlux2ProEditImageSize | 'auto' | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type FiboEditRestyleInput = {
     ...
     */
    style: '3D Render' | 'Cubism' | 'Oil Painting' | 'Anime' | 'Cartoon' | 'Coloring Book' | 'Retro Ad' | 'Pop Art Halftone' | 'Vector Art' | 'Story Board' | 'Art Nouveau' | 'Cross Etching' | 'Wood Cut';
    /**
     * Image Url
     *
     * The source image.
...
export type Flux2Klein4bBaseEditInput = {
     ...
     */
    image_size?: FalAiFlux2Klein4bBaseEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
...
export type Flux2Klein9bBaseEditInput = {
     ...
     * The size of the generated image. If not provided, uses the input image size.
     */
    image_size?: FalAiFlux2Klein9bBaseEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The acceleration level to use for image generation.
...
export type Flux2Klein4bEditInput = {
     ...
     * The size of the generated image. If not provided, uses the input image size.
     */
    image_size?: FalAiFlux2Klein4bEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type Flux2Klein9bEditInput = {
     ...
     * The size of the generated image. If not provided, uses the input image size.
     */
    image_size?: FalAiFlux2Klein9bEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type GlmImageImageToImageInput = {
     ...
     * Output image size.
     */
    image_size?: FalAiGlmImageImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'portrait_3_2' | 'landscape_3_2' | 'portrait_hd' | 'landscape_hd';
    /**
     * Enable Safety Checker
     *
...
export type QwenImageEdit2511MultipleAnglesInput = {
     ...
     */
    image_size?: FalAiQwenImageEdit2511MultipleAnglesImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
...
export type QwenImageEdit2511LoraInput = {
     ...
     */
    image_size?: FalAiQwenImageEdit2511LoraImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
...
export type AiHomeStyleInput = {
     ...
     */
    style: 'minimalistic-interior' | 'farmhouse-interior' | 'luxury-interior' | 'modern-interior' | 'zen-interior' | 'mid century-interior' | 'airbnb-interior' | 'cozy-interior' | 'rustic-interior' | 'christmas-interior' | 'bohemian-interior' | 'tropical-interior' | 'industrial-interior' | 'japanese-interior' | 'vintage-interior' | 'loft-interior' | 'halloween-interior' | 'soho-interior' | 'baroque-interior' | 'kids room-interior' | 'girls room-interior' | 'boys room-interior' | 'scandinavian-interior' | 'french country-interior' | 'mediterranean-interior' | 'cyberpunk-interior' | 'hot pink-interior' | 'biophilic-interior' | 'ancient egypt-interior' | 'pixel-interior' | 'art deco-interior' | 'modern-exterior' | 'minimalistic-exterior' | 'farmhouse-exterior' | 'cozy-exterior' | 'luxury-exterior' | 'colonial-exterior' | 'zen-exterior' | 'asian-exterior' | 'creepy-exterior' | 'airstone-exterior' | 'ancient greek-exterior' | 'art deco-exterior' | 'brutalist-exterior' | 'christmas lights-exterior' | 'contemporary-exterior' | 'cottage-exterior' | 'dutch colonial-exterior' | 'federal colonial-exterior' | 'fire-exterior' | 'french provincial-exterior' | 'full glass-exterior' | 'georgian colonial-exterior' | 'gothic-exterior' | 'greek revival-exterior' | 'ice-exterior' | 'italianate-exterior' | 'mediterranean-exterior' | 'midcentury-exterior' | 'middle eastern-exterior' | 'minecraft-exterior' | 'morocco-exterior' | 'neoclassical-exterior' | 'spanish-exterior' | 'tudor-exterior' | 'underwater-exterior' | 'winter-exterior' | 'yard lighting-exterior';
    /**
     * Architecture Type
     *
     * Type of architecture for appropriate furniture selection
     */
    architecture_type: 'living room-interior' | 'bedroom-interior' | 'kitchen-interior' | 'dining room-interior' | 'bathroom-interior' | 'laundry room-interior' | 'home office-interior' | 'study room-interior' | 'dorm room-interior' | 'coffee shop-interior' | 'gaming room-interior' | 'restaurant-interior' | 'office-interior' | 'attic-interior' | 'toilet-interior' | 'other-interior' | 'house-exterior' | 'villa-exterior' | 'backyard-exterior' | 'courtyard-exterior' | 'ranch-exterior' | 'office-exterior' | 'retail-exterior' | 'tower-exterior' | 'apartment-exterior' | 'school-exterior' | 'museum-exterior' | 'commercial-exterior' | 'residential-exterior' | 'other-exterior';
    /**
     * Color Palette
     *
     * Color palette for furniture and decor
     */
    color_palette: 'surprise me' | 'golden beige' | 'refined blues' | 'dusky elegance' | 'emerald charm' | 'crimson luxury' | 'golden sapphire' | 'soft pastures' | 'candy sky' | 'peach meadow' | 'muted sands' | 'ocean breeze' | 'frosted pastels' | 'spring bloom' | 'gentle horizon' | 'seaside breeze' | 'azure coast' | 'golden shore' | 'mediterranean gem' | 'ocean serenity' | 'serene blush' | 'muted horizon' | 'pastel shores' | 'dusky calm' | 'woodland retreat' | 'meadow glow' | 'forest canopy' | 'riverbank calm' | 'earthy tones' | 'earthy neutrals' | 'arctic mist' | 'aqua drift' | 'blush bloom' | 'coral haze' | 'retro rust' | 'autumn glow' | 'rustic charm' | 'vintage sage' | 'faded plum' | 'electric lime' | 'violet pulse' | 'neon sorbet' | 'aqua glow' | 'fluorescent sunset' | 'lavender bloom' | 'petal fresh' | 'meadow light' | 'sunny pastures' | 'frosted mauve' | 'snowy hearth' | 'icy blues' | 'winter twilight' | 'earthy hues' | 'stone balance' | 'neutral sands' | 'slate shades';
    /**
     * Style Image Url
     *
...
export type V26ImageToImageInput = {
     ...
     */
    image_size?: WanV26ImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Enable Prompt Expansion
     *
...
export type QwenImageEdit2511Input = {
     ...
     * The size of the generated image. If None, uses the input image dimensions.
     */
    image_size?: FalAiQwenImageEdit2511ImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The acceleration level to use.
...
export type ZImageTurboInpaintInput = {
     ...
     */
    image_size?: FalAiZImageTurboInpaintImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'auto';
    /**
     * Acceleration
     *
     * The acceleration level to use.
...
export type Flux2FlashEditInput = {
     ...
     * The size of the image to generate. The width and height must be between 512 and 2048 pixels.
     */
    image_size?: FalAiFlux2FlashEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type Flux2TurboEditInput = {
     ...
     * The size of the image to generate. The width and height must be between 512 and 2048 pixels.
     */
    image_size?: FalAiFlux2TurboEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type Flux2MaxEditInput = {
     ...
     * The size of the generated image. If `auto`, the size will be determined by the model.
     */
    image_size?: FalAiFlux2MaxEditImageSize | 'auto' | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type AiBabyAndAgingGeneratorMultiInput = {
     ...
     * The size of the generated image
     */
    image_size?: HalfMoonAiAiBabyAndAgingGeneratorMultiImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Father Weight
     *
     ...
     */
    age_group: 'baby' | 'toddler' | 'preschool' | 'gradeschooler' | 'teen' | 'adult' | 'mid' | 'senior';
    /**
     * Gender
     *
...
export type AiBabyAndAgingGeneratorSingleInput = {
     ...
     * The size of the generated image
     */
    image_size?: HalfMoonAiAiBabyAndAgingGeneratorSingleImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Id Image Urls
     *
...
export type QwenImageEdit2509LoraGalleryShirtDesignInput = {
     ...
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryShirtDesignImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
...
export type QwenImageEdit2509LoraGalleryRemoveLightingInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryRemoveLightingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryRemoveElementInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryRemoveElementImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryLightingRestorationInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryLightingRestorationImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryIntegrateProductInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryIntegrateProductImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryGroupPhotoInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryGroupPhotoImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryFaceToFullPortraitInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryFaceToFullPortraitImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryAddBackgroundInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryAddBackgroundImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryNextSceneInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryNextSceneImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEdit2509LoraGalleryMultipleAnglesInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEdit2509LoraGalleryMultipleAnglesImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Wide-Angle Lens
     *
...
export type QwenImageEdit2509LoraInput = {
     ...
     */
    image_size?: FalAiQwenImageEdit2509LoraImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
...
export type QwenImageEdit2509Input = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEdit2509ImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryLightingRestorationInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryLightingRestorationImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type ZImageTurboControlnetInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiZImageTurboControlnetImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'auto';
    /**
     * Acceleration
     *
     * The acceleration level to use.
...
export type ZImageTurboImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiZImageTurboImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'auto';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type BytedanceSeedreamV45EditInput = {
     ...
     */
    image_size?: FalAiBytedanceSeedreamV45EditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'auto_2K' | 'auto_4K';
    /**
     * Max Images
     *
...
export type Flux2LoraGalleryVirtualTryonInput = {
     ...
     * The size of the generated image. If not provided, the size of the input image will be used.
     */
    image_size?: FalAiFlux2LoraGalleryVirtualTryonImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type Flux2LoraGalleryMultipleAnglesInput = {
     ...
     * The size of the generated image. If not provided, the size of the input image will be used.
     */
    image_size?: FalAiFlux2LoraGalleryMultipleAnglesImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation.
...
export type Flux2LoraGalleryFaceToFullPortraitInput = {
     ...
     * The size of the generated image. If not provided, the size of the input image will be used.
     */
    image_size?: FalAiFlux2LoraGalleryFaceToFullPortraitImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type Flux2LoraGalleryApartmentStagingInput = {
     ...
     * The size of the generated image. If not provided, the size of the input image will be used.
     */
    image_size?: FalAiFlux2LoraGalleryApartmentStagingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type Flux2LoraGalleryAddBackgroundInput = {
     ...
     * The size of the generated image. If not provided, the size of the input image will be used.
     */
    image_size?: FalAiFlux2LoraGalleryAddBackgroundImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type Flux2FlexEditInput = {
     ...
     * The size of the generated image. If `auto`, the size will be determined by the model.
     */
    image_size?: FalAiFlux2FlexEditImageSize | 'auto' | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type QwenImageEditPlusLoraGalleryMultipleAnglesInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryMultipleAnglesImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Wide-Angle Lens
     *
     * Enable wide-angle lens effect
...
export type QwenImageEditPlusLoraGalleryShirtDesignInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryShirtDesignImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryRemoveLightingInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryRemoveLightingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryRemoveElementInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryRemoveElementImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryNextSceneInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryNextSceneImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryIntegrateProductInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryIntegrateProductImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryGroupPhotoInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryGroupPhotoImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryFaceToFullPortraitInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryFaceToFullPortraitImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type QwenImageEditPlusLoraGalleryAddBackgroundInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used.
     */
    image_size?: FalAiQwenImageEditPlusLoraGalleryAddBackgroundImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Acceleration
     *
     * Acceleration level for image generation. 'regular' balances speed and quality.
...
export type Emu35ImageEditImageInput = {
     ...
     */
    aspect_ratio?: 'auto' | '21:9' | '16:9' | '4:3' | '3:2' | '1:1' | '2:3' | '3:4' | '9:16' | '9:21';
    /**
     * Output Format
     *
     * The format of the output image.
...
export type QwenImageEditPlusLoraInput = {
     ...
     * The size of the generated image. If not provided, the size of the final input image will be used to calculate the size of the output image.
     */
    image_size?: FalAiQwenImageEditPlusLoraImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type QwenImageEditImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEditImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type Wan25PreviewImageToImageInput = {
     ...
     */
    image_size?: FalAiWan25PreviewImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Enable Safety Checker
     *
     * If set to true, the safety checker will be enabled.
...
export type QwenImageEditPlusInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEditPlusImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type ImageAppsV2TextureTransformInput = {
     ...
     * Target Texture
     */
    target_texture?: 'cotton' | 'denim' | 'wool' | 'felt' | 'wood' | 'leather' | 'velvet' | 'stone' | 'marble' | 'ceramic' | 'concrete' | 'brick' | 'clay' | 'foam' | 'glass' | 'metal' | 'silk' | 'fabric' | 'crystal' | 'rubber' | 'plastic' | 'lace';
...
export type ImageAppsV2RelightingInput = {
     ...
     * Lighting Style
     */
    lighting_style?: 'natural' | 'studio' | 'golden_hour' | 'blue_hour' | 'dramatic' | 'soft' | 'hard' | 'backlight' | 'side_light' | 'front_light' | 'rim_light' | 'sunset' | 'sunrise' | 'neon' | 'candlelight' | 'moonlight' | 'spotlight' | 'ambient';
    /**
     * Image Url
     *
...
export type ImageAppsV2StyleTransferInput = {
     ...
     * Target Style
     */
    target_style?: 'anime_character' | 'cartoon_3d' | 'hand_drawn_animation' | 'cyberpunk_future' | 'anime_game_style' | 'comic_book_animation' | 'animated_series' | 'cartoon_animation' | 'lofi_aesthetic' | 'cottagecore' | 'dark_academia' | 'y2k' | 'vaporwave' | 'liminal_space' | 'weirdcore' | 'dreamcore' | 'synthwave' | 'outrun' | 'photorealistic' | 'hyperrealistic' | 'digital_art' | 'concept_art' | 'impressionist' | 'anime' | 'pixel_art' | 'claymation';
...
export type ImageAppsV2PhotographyEffectsInput = {
     ...
     * Effect Type
     */
    effect_type?: 'film' | 'vintage_film' | 'portrait_photography' | 'fashion_photography' | 'street_photography' | 'sepia_tone' | 'film_grain' | 'light_leaks' | 'vignette_effect' | 'instant_camera' | 'golden_hour' | 'dramatic_lighting' | 'soft_focus' | 'bokeh_effect' | 'high_contrast' | 'double_exposure';
...
export type ImageAppsV2PerspectiveInput = {
     ...
     * Target Perspective
     */
    target_perspective?: 'front' | 'left_side' | 'right_side' | 'back' | 'top_down' | 'bottom_up' | 'birds_eye' | 'three_quarter_left' | 'three_quarter_right';
    /**
     * Image Url
     *
...
export type ImageAppsV2HairChangeInput = {
     ...
     * Target Hairstyle
     */
    target_hairstyle?: 'short_hair' | 'medium_long_hair' | 'long_hair' | 'curly_hair' | 'wavy_hair' | 'high_ponytail' | 'bun' | 'bob_cut' | 'pixie_cut' | 'braids' | 'straight_hair' | 'afro' | 'dreadlocks' | 'buzz_cut' | 'mohawk' | 'bangs' | 'side_part' | 'middle_part';
    aspect_ratio?: FalAiImageAppsV2HairChangeAspectRatio;
    /**
     * Hair Color
     */
    hair_color?: 'black' | 'dark_brown' | 'light_brown' | 'blonde' | 'platinum_blonde' | 'red' | 'auburn' | 'gray' | 'silver' | 'blue' | 'green' | 'purple' | 'pink' | 'rainbow' | 'natural' | 'highlights' | 'ombre' | 'balayage';
    /**
     * Image Url
     *
...
export type ImageAppsV2ExpressionChangeInput = {
     ...
     * Target Expression
     */
    target_expression?: 'smile' | 'surprise' | 'glare' | 'panic' | 'shyness' | 'laugh' | 'cry' | 'angry' | 'sad' | 'happy' | 'excited' | 'shocked' | 'confused' | 'focused' | 'dreamy' | 'serious' | 'playful' | 'mysterious' | 'confident' | 'thoughtful';
    /**
     * Image Url
     *
...
export type ImageAppsV2CityTeleportInput = {
     ...
     * Type of photo shot
     */
    photo_shot?: 'extreme_close_up' | 'close_up' | 'medium_close_up' | 'medium_shot' | 'medium_long_shot' | 'long_shot' | 'extreme_long_shot' | 'full_body';
    /**
     * Camera Angle
     *
     * Camera angle for the shot
     */
    camera_angle?: 'eye_level' | 'low_angle' | 'high_angle' | 'dutch_angle' | 'birds_eye_view' | 'worms_eye_view' | 'overhead' | 'side_angle';
    /**
     * Person Image Url
     *
     * Person photo URL
...
export type ImageAppsV2MakeupApplicationInput = {
     ...
     * Makeup Style
     */
    makeup_style?: 'natural' | 'glamorous' | 'smoky_eyes' | 'bold_lips' | 'no_makeup' | 'remove_makeup' | 'dramatic' | 'bridal' | 'professional' | 'korean_style' | 'artistic';
    /**
     * Image Url
     *
...
export type QwenImageEditInpaintInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEditInpaintImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type QwenImageEditLoraInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEditLoraImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type BytedanceSeedreamV4EditInput = {
     ...
     */
    image_size?: FalAiBytedanceSeedreamV4EditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | 'auto' | 'auto_2K' | 'auto_4K';
    /**
     * Enhance Prompt Mode
     *
...
export type WanV22A14bImageToImageInput = {
     ...
     * Image Size
     */
    image_size?: FalAiWanV22A14bImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Guidance Scale
     *
     * Classifier-free guidance scale.
...
export type UsoInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiUsoImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
...
export type QwenImageImageToImageInput = {
     ...
     */
    image_size?: FalAiQwenImageImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Loras
     *
     *
...
export type QwenImageEditInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiQwenImageEditImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * Acceleration level for image generation. Options: 'none', 'regular'. Higher acceleration increases speed. 'regular' balances speed and quality.
...
export type IdeogramCharacterInput = {
     ...
     */
    image_size?: FalAiIdeogramCharacterImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Style
     *
     * The style type to generate with. Cannot be used with style_codes.
...
export type IdeogramCharacterRemixInput = {
     ...
     * The resolution of the generated image
     */
    image_size?: FalAiIdeogramCharacterRemixImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Style
     *
     * The style type to generate with. Cannot be used with style_codes.
...
export type FluxKreaLoraInpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxKreaLoraInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type FluxKreaLoraImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxKreaLoraImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type FluxKreaReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxKreaReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type Flux1KreaReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFlux1KreaReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type CalligrapherInput = {
     ...
     */
    image_size?: FalAiCalligrapherImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
...
export type PostProcessingDodgeBurnInput = {
     ...
     * Dodge and burn mode
     */
    dodge_burn_mode?: 'dodge' | 'burn' | 'dodge_and_burn' | 'burn_and_dodge' | 'color_dodge' | 'color_burn' | 'linear_dodge' | 'linear_burn';
    /**
...
export type TopazUpscaleImageInput = {
     ...
     */
    model?: 'Low Resolution V2' | 'Standard V2' | 'CGI' | 'High Fidelity V2' | 'Text Refine' | 'Recovery' | 'Redefine' | 'Recovery V2';
    /**
     * Image Url
     *
...
export type Flux1SchnellReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFlux1SchnellReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type Flux1DevReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFlux1DevReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type HidreamI1FullImageToImageInput = {
     ...
     */
    image_size?: FalAiHidreamI1FullImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type IdeogramV3ReframeInput = {
     ...
     */
    image_size: FalAiIdeogramV3ReframeImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Style
     *
     * The style type to generate with. Cannot be used with style_codes.
...
export type IdeogramV3RemixInput = {
     ...
     * The resolution of the generated image
     */
    image_size?: FalAiIdeogramV3RemixImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | unknown;
    /**
     * Style
     *
     * The style type to generate with. Cannot be used with style_codes.
...
export type UnoInput = {
     ...
     *
     */
    image_size?: FalAiUnoImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type JuggernautFluxLoraInpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: RundiffusionFalJuggernautFluxLoraInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type InstantCharacterInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiInstantCharacterImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Scale
     *
...
export type FluxControlLoraCannyImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxControlLoraCannyImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Loras
     *
     *
...
export type FluxControlLoraDepthImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxControlLoraDepthImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Loras
     *
     *
...
export type FluxLoraCannyInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxLoraCannyImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type CatVtonInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiCatVtonImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Human Image Url
     *
     * Url for the human image.
...
export type FluxSchnellReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxSchnellReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type FluxProV11ReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxProV11ReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type FluxDevReduxInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxDevReduxImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Acceleration
     *
     * The speed of the generation. The higher the speed, the faster the generation.
...
export type FluxLoraDepthInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxLoraDepthImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type KolorsImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiKolorsImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type IclightV2Input = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiIclightV2ImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
...
export type FluxPulidInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxPulidImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Start Step
     *
...
export type BirefnetV2Input = {
     ...
     *
     */
    model?: 'General Use (Light)' | 'General Use (Light 2K)' | 'General Use (Heavy)' | 'Matting' | 'Portrait' | 'General Use (Dynamic)';
    /**
     * Sync Mode
     *
     * If `True`, the media will be returned as a data URI and the output data won't be available in the request history.
...
export type FluxLoraImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFluxLoraImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Output Format
     *
     * The format of the generated image.
...
export type SdxlControlnetUnionInpaintingInput = {
     ...
     */
    image_size?: FalAiSdxlControlnetUnionInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Normal Image Url
     *
...
export type SdxlControlnetUnionImageToImageInput = {
     ...
     * The size of the generated image. Leave it none to automatically infer from the control image.
     */
    image_size?: FalAiSdxlControlnetUnionImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Normal Image Url
     *
     * The URL of the control image.
...
export type StableDiffusionV3MediumImageToImageInput = {
     ...
     */
    image_size?: FalAiStableDiffusionV3MediumImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Prompt
     *
     * The prompt to generate an image from.
...
export type DwposeInput = {
     ...
     */
    draw_mode?: 'full-pose' | 'body-pose' | 'face-pose' | 'hand-pose' | 'face-hand-mask' | 'face-mask' | 'hand-mask';
    /**
     * Image Url
     *
     * URL of the image to be processed
...
export type Sd15DepthControlnetInput = {
     ...
     * The size of the generated image. Leave it none to automatically infer from the control image.
     */
    image_size?: FalAiSd15DepthControlnetImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Expand Prompt
     *
     * If set to true, the prompt will be expanded with additional prompts.
...
export type FastSdxlImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastSdxlImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type FastSdxlInpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastSdxlInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type FaceToStickerInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFaceToStickerImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * IP adapter weight
     *
...
export type FastLightningSdxlImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastLightningSdxlImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type PlaygroundV25InpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiPlaygroundV25InpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type PlaygroundV25ImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiPlaygroundV25ImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type FastLightningSdxlInpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastLightningSdxlInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Embeddings
     *
     * The list of embeddings to use.
...
export type FastLcmDiffusionInpaintingInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastLcmDiffusionInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Expand Prompt
     *
     * If set to true, the prompt will be expanded with additional prompts.
...
export type FastLcmDiffusionImageToImageInput = {
     ...
     * The size of the generated image.
     */
    image_size?: FalAiFastLcmDiffusionImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Expand Prompt
     *
     * If set to true, the prompt will be expanded with additional prompts.
...
export type PulidInput = {
     ...
     */
    image_size?: FalAiPulidImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9';
    /**
     * Id Scale
     *
     * ID scale
...
export type FastSdxlControlnetCannyInpaintingInput = {
     ...
     * The size of the generated image. Leave it none to automatically infer from the control image.
     */
    image_size?: FalAiFastSdxlControlnetCannyInpaintingImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Expand Prompt
     *
     * If set to true, the prompt will be expanded with additional prompts.
...
export type FastSdxlControlnetCannyImageToImageInput = {
     ...
     * The size of the generated image. Leave it none to automatically infer from the control image.
     */
    image_size?: FalAiFastSdxlControlnetCannyImageToImageImageSize | 'square_hd' | 'square' | 'portrait_4_3' | 'portrait_16_9' | 'landscape_4_3' | 'landscape_16_9' | null;
    /**
     * Expand Prompt
     *
     * If set to true, the prompt will be expanded with additional prompts.
