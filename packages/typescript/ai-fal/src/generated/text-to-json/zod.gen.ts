 ...
 * PhotographicCharacteristics
 */
export const zBriaFiboLiteGenerateStructuredPromptLitePhotographicCharacteristics = z.object({
    focus: z.optional(z.union([
        z.string(),
        z.unknown()
    ])),
...
export const zBriaFiboVlmStructuredPrompt = z.object({
    ...
    aesthetics: z.optional(z.union([
        zBriaFiboVlmAesthetics,
        z.unknown()
    ])),
    lighting: z.optional(z.union([
        zBriaFiboLiteGenerateStructuredPromptLiteLighting,
        z.unknown()
    ])),
    short_description: z.optional(z.union([
        z.string(),
 ...
 * PhotographicCharacteristics
 */
export const zBriaFiboGenerateStructuredPromptPhotographicCharacteristics = z.object({
    focus: z.optional(z.union([
        z.string(),
        z.unknown()
    ])),
...
export const zBriaFiboGenerateStructuredPromptStructuredPrompt = z.object({
    ...
    aesthetics: z.optional(z.union([
        zBriaFiboGenerateStructuredPromptAesthetics,
        z.unknown()
    ])),
    photographic_characteristics: z.optional(z.union([
    ...
    lighting: z.optional(z.union([
        zBriaFiboGenerateStructuredPromptLighting,
        z.unknown()
    ])),
    short_description: z.optional(z.union([
        z.string(),
...
export const zFiboGenerateStructuredPromptInput = z.object({
    ...
    seed: z.optional(z.int()).default(5555),
    structured_prompt: z.optional(z.union([
        zBriaFiboGenerateStructuredPromptStructuredPrompt,
        z.unknown()
    ])),
    image_url: z.optional(z.union([
        z.string(),
